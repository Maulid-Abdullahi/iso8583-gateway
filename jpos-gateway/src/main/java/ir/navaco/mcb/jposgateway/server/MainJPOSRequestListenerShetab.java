 ...
 * */
public class MainJPOSRequestListenerShetab implements ISORequestListener, Configurable {
    ...
    public boolean process(ISOSource isoSource, ISOMsg isoMsg) {
        ...
        context.put(ContextConstant.SHETAB_REQUEST_KEY, isoMsg);
        context.put(ContextConstant.SHETAB_SOURCE_KEY, isoSource);
